        ...
        <div>
            <div className="flex flex-col gap-5 relative lg:ml-24 ml-4">
                <div className='flex mx-5'>
                    ...
                    <button onClick={() => { navigate("/subscriptions") }} className="px-4 py-1 rounded-full bg-blue-600 text-white font-semibold hover:bg-blue-700 active:bg-blue-800 transition">
                        Subscriptions
                    </button>
                </div>
                {
