            ...
            <div className="flex flex-wrap ml-4 justify-between xl:px-48 lg:px-36 md:px-24 items-center mr-5">
                <div className="flex flex-wrap mb-2">
                    ...
                    <div className="flex flex-col w-auto mx-2 px-2 flex-wrap mt-3">
                        ...
                        <span className="dark:text-white/60 text-xs font-[400]">{location.pathname === "/yourSubscribers" ? subscriber?.subscriber?.username : subscriber?.channel?.username} • {subscriber?.noOfSubscribers} subscribers</span>
                    </div>
                </div>
